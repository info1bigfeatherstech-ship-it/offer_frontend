...
const CLIENT_PAGE_SIZE = 24; // Changed from 20 to 24 for 4 rows of 6 cards on desktop
    ...
    <div className="w-full min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 flex gap-8">
        ...
        <div className="flex-1">
          ...
          {/* Loading skeleton - Updated for 6 cards on desktop, 2 on mobile */}
          {showLoading && (
          ...
          {/* Product Grid - Updated for 6 cards on desktop, 2 on mobile */}
...
// udpated code show 6 cards instead of 4  in large screen in mobile we show 2 cards 
