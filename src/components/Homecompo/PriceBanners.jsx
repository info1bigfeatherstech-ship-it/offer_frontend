...
const PriceBanners = () => {
    ...
    // FIXED: Exclusive price ranges - NO OVERLAPPING
    const priceCounts = useMemo(() => {
        ...
        for (const product of products) {
            ...
            // EXCLUSIVE ranges - each product appears in ONLY ONE category
            if (price <= 29) {
                under29++;
            } else if (price <= 49) {  // This means: price > 29 AND price <= 49
                under49++;
            } else if (price <= 79) {  // This means: price > 49 AND price <= 79
                under79++;
            } else if (price > 99) {   // This means: price > 99
                above99++;
            }
            // Products priced 80-99 are intentionally not shown in any banner
        }
