...
const AdminDashboard = () => {
  ...
  const handleTabClick = (tab) => {
    ...
    // Close sidebar on mobile after any tab click
  ...
  const handleSubItemClick = (parentId, subId) => {
    ...
    // Close sidebar on mobile after sub-item click
    setIsSidebarOpen(false);
  };
      ...
      {isSettingsActive ? (
        ...
        <main className="flex-1 overflow-y-auto">
          <header className="bg-white h-16 border-b border-gray-200 flex items-center px-8 sticky top-0 z-10">
            ...
            <button
              className="mr-4 p-1.5 rounded-lg text-gray-500 hover:bg-gray-100 md:hidden"
